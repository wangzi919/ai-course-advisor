...
# -*- coding: utf-8 -*-
"""
此腳本會執行 OAASOPScraper 來更新教務處 SOP 標準作業流程資料。
...
# --- 路徑設定 ---
try:
    from scrapers.oaa_sop import OAASOPScraper
except ImportError:
    ...
    try:
        ...
        logging.error(f"無法匯入 OAASOPScraper: {e}")
        sys.exit(1)
...
def main():
    ...
    主函式，用於初始化並執行爬蟲。
    """
    logging.info("開始更新教務處 SOP 標準作業流程資料...")
    try:
        scraper = OAASOPScraper()
        scraper.force_update()
        logging.info("教務處 SOP 標準作業流程資料更新成功。")
        sys.exit(0)
