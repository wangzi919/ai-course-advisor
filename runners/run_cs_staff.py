...
# -*- coding: utf-8 -*-
"""
此腳本會執行 CSStaffScraper 來更新資訊工程學系行政人員資料。
...
# --- 路徑設定 ---
try:
    from scrapers.cs_staff import CSStaffScraper
except ImportError:
    ...
    try:
        ...
        logging.error(f"無法匯入 CSStaffScraper: {e}")
        sys.exit(1)
...
def main():
    ...
    主函式，用於初始化並執行爬蟲。
    """
    logging.info("開始更新資訊工程學系行政人員資料...")
    try:
        scraper = CSStaffScraper()
        scraper.force_update()
        logging.info("資訊工程學系行政人員資料更新成功。")
        sys.exit(0)
