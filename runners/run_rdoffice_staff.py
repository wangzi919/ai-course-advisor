...
# -*- coding: utf-8 -*-
"""
此腳本會執行 RDOfficeStaffScraper 來更新研發處校務發展中心教職員資料。
...
# --- 路徑設定 ---
try:
    from scrapers.rdoffice_staff import RDOfficeStaffScraper
except ImportError:
    ...
    try:
        ...
        logging.error(f"無法匯入 RDOfficeStaffScraper: {e}")
        sys.exit(1)
...
def main():
    ...
    主函式，用於初始化並執行爬蟲。
    """
    logging.info("開始更新研發處校務發展中心教職員資料...")
    try:
        scraper = RDOfficeStaffScraper()
        scraper.force_update()
        logging.info("研發處校務發展中心教職員資料更新成功。")
        sys.exit(0)
