...
# -*- coding: utf-8 -*-
"""
此腳本會執行 HESPStaffScraper 來更新高等教育深耕計畫教職員資料。
...
# --- 路徑設定 ---
try:
    from scrapers.hesp_staff import HESPStaffScraper
except ImportError:
    ...
    try:
        ...
        logging.error(f"無法匯入 HESPStaffScraper: {e}")
        sys.exit(1)
...
def main():
    ...
    主函式，用於初始化並執行爬蟲。
    """
    logging.info("開始更新高等教育深耕計畫教職員資料...")
    try:
        scraper = HESPStaffScraper()
        scraper.force_update()
        logging.info("高等教育深耕計畫教職員資料更新成功。")
        sys.exit(0)
