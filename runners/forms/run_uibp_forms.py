...
# -*- coding: utf-8 -*-
"""
此腳本會執行 UIBPFormsScraper 來更新校學士表單資料。
...
# --- 路徑設定 ---
try:
    from scrapers.forms.uibp_forms import UIBPFormsScraper
except ImportError:
    ...
    try:
        ...
        logging.error(f"無法匯入 UIBPFormsScraper: {e}")
        sys.exit(1)
...
def main():
    ...
    主函式，用於初始化並執行爬蟲。
    """
    logging.info("開始更新校學士表單資料...")
    try:
        scraper = UIBPFormsScraper()
        scraper.force_update()
        logging.info("校學士表單資料更新成功。")
        sys.exit(0)
