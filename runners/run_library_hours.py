...
# -*- coding: utf-8 -*-
"""
此腳本會執行 LibraryHoursScraper 來更新圖書館開放時間資料。
...
# --- 路徑設定 ---
try:
    from scrapers.library_hours import LibraryHoursScraper
except ImportError:
    ...
    try:
        ...
        logging.error(f"無法匯入 LibraryHoursScraper: {e}")
        sys.exit(1)
...
def main():
    ...
    主函式，用於初始化並執行爬蟲。
    """
    logging.info("開始更新圖書館開放時間...")
    try:
        scraper = LibraryHoursScraper()
        scraper.force_update()
        logging.info("圖書館開放時間更新成功。")
        sys.exit(0)
