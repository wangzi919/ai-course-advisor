...
# -*- coding: utf-8 -*-
"""
此腳本會執行 OAARulesScraper 來更新教務處規章資料。
...
# --- 路徑設定 ---
try:
    from scrapers.oaa_rules import OAARulesScraper
except ImportError:
    ...
    try:
        ...
        logging.error(f"無法匯入 OAARulesScraper: {e}")
        sys.exit(1)
...
def main():
    ...
    主函式，用於初始化並執行爬蟲。
    """
    logging.info("開始更新教務處規章資料...")
    try:
        scraper = OAARulesScraper()
        scraper.force_update()
        logging.info("教務處規章資料更新成功。")
        sys.exit(0)
