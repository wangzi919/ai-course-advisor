...
# -*- coding: utf-8 -*-
"""
此腳本會執行 OIAStaffScraper 來更新國際事務處教職員資料。
...
# --- 路徑設定 ---
try:
    from scrapers.oia_staff import OIAStaffScraper
except ImportError:
    ...
    try:
        ...
        logging.error(f"無法匯入 OIAStaffScraper: {e}")
        sys.exit(1)
...
def main():
    ...
    主函式，用於初始化並執行爬蟲。
    """
    logging.info("開始更新國際事務處教職員資料...")
    try:
        scraper = OIAStaffScraper()
        scraper.force_update()
        logging.info("國際事務處教職員資料更新成功。")
        sys.exit(0)
