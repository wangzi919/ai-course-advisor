...
class GcaicStaffScraper(BaseScraper):
    """產學研鏈結中心人員職務資料爬蟲"""

    def __init__(self):
        super().__init__(
            source_url=SOURCE_URL,
            output_filename='gcaic_staff.json',
            data_dir='staff/gcaic',
        )

        staff_dir = self.data_dir.parent  # data/staff
        cache_dir = staff_dir / 'cache'
        cache_dir.mkdir(parents=True, exist_ok=True)
        self.html_cache_path = cache_dir / 'gcaic_staff_cache.html'
