...
class RDOfficeStaffScraper(BaseScraper):
    """研發處校務發展中心教職員資料爬蟲"""

    def __init__(self):
        """初始化爬蟲"""
        super().__init__(
            source_url="https://research.nchu.edu.tw/unit-sale/unit/6/mid/68",
            output_filename="rdoffice_staff.json",
        ...
        self.html_cache_path = cache_dir / "rdoffice_staff_cache.html"
