...
class AcademicDevStaffScraper(BaseScraper):
    """研發處學術發展組教職員資料爬蟲"""

    def __init__(self):
        """初始化爬蟲"""
        super().__init__(
            source_url="https://research.nchu.edu.tw/unit-sale/unit/7/mid/39",
            output_filename="academic_dev_staff.json",
            data_dir="staff/rdoffice"  # 與校務發展中心放在同一目錄
        )
        ...
        self.html_cache_path = cache_dir / "academic_dev_staff_cache.html"
