...
class ProjectServiceStaffScraper(BaseScraper):
    """研發處計畫業務組教職員資料爬蟲"""

    def __init__(self):
        """初始化爬蟲"""
        super().__init__(
            source_url="https://research.nchu.edu.tw/unit-sale/unit/8/mid/49",
            output_filename="project_service_staff.json",
        ...
        self.html_cache_path = cache_dir / "project_service_staff_cache.html"
